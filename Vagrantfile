...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "ubuntu", autostart: false do |ubuntu|
    ...
    config.vm.provision "shell", inline: "apt-get update; DEBIAN_FRONTEND=noninteractive apt-get install -y golang git iptables qemu-utils selinux-utils systemd-container tmux"
